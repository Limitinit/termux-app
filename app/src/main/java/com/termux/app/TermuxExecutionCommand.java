...
public class TermuxExecutionCommand {
    ...
    */
    ...
    /** The {@link Enum} that defines {@link TermuxExecutionCommand} state. */
    ...
    /** The optional unique id for the {@link TermuxExecutionCommand}. This should equal -1 if execution
    ...
    /** The current state of the {@link TermuxExecutionCommand}. */
    private ExecutionState currentState = ExecutionState.PRE_EXECUTION;
    /** The previous state of the {@link TermuxExecutionCommand}. */
    private ExecutionState previousState = ExecutionState.PRE_EXECUTION;


    /** The executable for the {@link TermuxExecutionCommand}. */
    public String executable;
    /** The executable Uri for the {@link TermuxExecutionCommand}. */
    public Uri executableUri;
    /** The executable arguments array for the {@link TermuxExecutionCommand}. */
    public String[] arguments;
    /** The stdin string for the {@link TermuxExecutionCommand}. */
    public String stdin;
    /** The current working directory for the {@link TermuxExecutionCommand}. */
    public String workingDirectory;


    /** The terminal transcript rows for the {@link TermuxExecutionCommand}. */
    public Integer terminalTranscriptRows;


    /** The {@link Runner} for the {@link TermuxExecutionCommand}. */
    public String runner;

    /** If the {@link TermuxExecutionCommand} is meant to start a failsafe terminal session. */
    public boolean isFailsafe;

    /**
     * The {@link TermuxExecutionCommand} custom log level for background {@link AppShell}
    ...
    /** Whether to set {@link TermuxExecutionCommand} shell environment. */
    public boolean setShellCommandShellEnvironment;




    /** The command label for the {@link TermuxExecutionCommand}. */
    public String commandLabel;
    /** The markdown text for the command description for the {@link TermuxExecutionCommand}. */
    public String commandDescription;
    /** The markdown text for the help of command for the {@link TermuxExecutionCommand}. This can be used
     ...
     * {@link TermuxExecutionCommand}. This can be used to provide useful info to the user if an internal
     * error is raised. */
    ...
    /** Defines if {@link TermuxExecutionCommand} was started because of an external plugin request
     * like with an intent or from within Termux app itself. */
    public boolean isPluginExecutionCommand;

    /** Defines the {@link ResultConfig} for the {@link TermuxExecutionCommand} containing information
     * on how to handle the result. */
    public final ResultConfig resultConfig = new ResultConfig();

    /** Defines the {@link ResultData} for the {@link TermuxExecutionCommand} containing information
     * of the result. */
    public final ResultData resultData = new ResultData();


    /** Defines if processing results already called for this {@link TermuxExecutionCommand}. */
    public boolean processingResultsAlreadyCalled;

    private static final String LOG_TAG = "ExecutionCommand";


    public TermuxExecutionCommand() {
    }

    public TermuxExecutionCommand(Integer id) {
        this.id = id;
    }

    public TermuxExecutionCommand(Integer id, String executable, String[] arguments, String stdin, String workingDirectory, String runner, boolean isFailsafe) {
        this.id = id;
    ...
    public synchronized boolean setState(ExecutionState newState) {
        ...
        if (newState.ordinal() < currentState.ordinal() || currentState == ExecutionState.SUCCESS) {
            Logger.logError(LOG_TAG, "Invalid "+ getCommandIdAndLabelLogString() + " state transition from " + currentState + " to " + newState);
            return false;
        }
    ...
    public synchronized boolean hasExecuted() {
        return currentState.ordinal() >= ExecutionState.EXECUTED.ordinal();
    }
    ...
    /**
     * Get a log friendly {@link String} for {@link TermuxExecutionCommand} execution input parameters.
     *
     * @param executionCommand The {@link TermuxExecutionCommand} to convert.
     ...
     */
    public static String getExecutionInputLogString(final TermuxExecutionCommand executionCommand, boolean ignoreNull, boolean logStdin) {
    ...
    /**
     * Get a log friendly {@link String} for {@link TermuxExecutionCommand} execution output parameters.
     *
     * @param executionCommand The {@link TermuxExecutionCommand} to convert.
     * @param ignoreNull Set to {@code true} if non-critical {@code null} values are to be ignored.
     ...
     * @return Returns the log friendly {@link String}.
     */
    public static String getExecutionOutputLogString(final TermuxExecutionCommand executionCommand, boolean ignoreNull, boolean logResultData, boolean logStdoutAndStderr) {
        if (executionCommand == null) return "null";
    ...
    /**
     * Get a log friendly {@link String} for {@link TermuxExecutionCommand} with more details.
     *
     * @param executionCommand The {@link TermuxExecutionCommand} to convert.
     * @return Returns the log friendly {@link String}.
     */
    public static String getDetailedLogString(final TermuxExecutionCommand executionCommand) {
        if (executionCommand == null) return "null";
    ...
    /**
     * Get a markdown {@link String} for {@link TermuxExecutionCommand}.
     *
     * @param executionCommand The {@link TermuxExecutionCommand} to convert.
     * @return Returns the markdown {@link String}.
     */
    public static String getExecutionCommandMarkdownString(final TermuxExecutionCommand executionCommand) {
        if (executionCommand == null) return "null";
        ...
        markdownString.append("\n").append(MarkdownUtils.getSingleLineMarkdownStringEntry("Previous State", executionCommand.previousState, "-"));
        markdownString.append("\n").append(MarkdownUtils.getSingleLineMarkdownStringEntry("Current State", executionCommand.currentState, "-"));
