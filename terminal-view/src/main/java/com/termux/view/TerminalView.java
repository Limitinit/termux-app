...
public final class TerminalView extends View {
    ...
    public void updateSize() {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            Log.e("termux", "topRadius=" + topRadius + ", bottomRadius=" + bottomRadius + ", topOffsetDueToRoundedCorners=" + topOffsetDueToRoundedCorners
            + ", bottomOffsetDueToRoundedCorners=" + bottomOffsetDueToRoundedCorners);
